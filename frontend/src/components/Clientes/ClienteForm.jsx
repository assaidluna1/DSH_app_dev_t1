...
export const ClienteForm = ({ initialData = null, onSubmit, onCancel, isSubmitting = false }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 text-xs">
      <div>
        <label className="block font-semibold text-surface-300 mb-1">Nombre de la Empresa *</label>
        <input
          type="text"
          required
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block font-semibold text-surface-300 mb-1">Industria</label>
          <input
            type="text"
        ...
        <div>
          <label className="block font-semibold text-surface-300 mb-1">Segmento</label>
          <select
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block font-semibold text-surface-300 mb-1">Ciudad</label>
          <input
            type="text"
        ...
        <div>
          <label className="block font-semibold text-surface-300 mb-1">Número de Empleados</label>
          <input
            type="number"
            min="1"
      ...
      <div>
        <label className="block font-semibold text-surface-300 mb-1">Sitio Web</label>
        <input
          type="url"
